...
def parse_args():
	...
	parser.add_argument('--negsamp', default=5, type=int, help='rate of negative sampling')
	...
	parser.add_argument('--dataset', default='Beibei', type=str, help='Beibei or Taobao')
	parser.add_argument("--Ks", nargs='?', type=int, default = [10, 50, 100], help="compute metrics@top_k")
